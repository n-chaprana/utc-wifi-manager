...
testcase tc_array[] = {
    ...
    {"utc_wifi_manager_update_ap_n", utc_wifi_manager_connect_n, utc_wifi_manager_startup, utc_wifi_manager_cleanup},
    {"utc_wifi_manager_update_ap_p", utc_wifi_manager_connect_p, utc_wifi_manager_startup, utc_wifi_manager_cleanup},
