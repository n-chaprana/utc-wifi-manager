...
int utc_wifi_manager_update_ap_p(void)
{
	...
	ret = wifi_manager_ap_get_proxy_address(hAP, WIFI_MANAGER_ADDRESS_FAMILY_IPV4, &proxy);
	CHECK_RETURN("wifi_manager_ap_get_proxy_address", ret, WIFI_MANAGER_ERROR_NONE);

	ret = wifi_manager_ap_set_gateway_address(hAP, WIFI_MANAGER_ADDRESS_FAMILY_IPV4, "192.168.11.1");
	...
	ret = wifi_manager_ap_set_gateway_address(hAP, WIFI_MANAGER_ADDRESS_FAMILY_IPV4, proxy);
	CHECK_RETURN("wifi_manager_ap_set_gateway_address", ret, WIFI_MANAGER_ERROR_NONE);
